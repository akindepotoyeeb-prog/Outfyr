  ...
  return (
    <div className="h-screen py-10 px-5">
        ...
        <form action="" className="mt-6 block ">
            ...
            <button type="submit" className="bg-[#e48045] w-full p-2 rounded mt-10 mb-20">
              Sign Up
            </button>
          </form>
          ...
          <div className="text-center mt-4 font-medium"><p>Don't have an account? <a href="#" className="text-[#e48045] ">Sign Up</a></p></div>
    </div>
  );
}
